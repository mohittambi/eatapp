...
function changeStatus(id)
{
  swal({
      ...
      function(){
        jQuery.ajax({
        url: '{{route('admin.emailTemplates.status.update')}}',
        type: 'POST',
        data:{id:id},
        headers: {
  ...
  $(function() {
    ...
    order: [[0, "desc" ]],
    "ajax":{
      "url": '{!! route('admin.emailTemplates.datatables') !!}',
      "dataType": "json",
      "type": "POST",
    ...
    columns: [ 
      ...
      { data: 'from_email', name: 'from_email', orderable:true},
    ...
    ,language: {
        searchPlaceholder: "Search by title, from_email or subject"
    }
    });    
  });
</script>
