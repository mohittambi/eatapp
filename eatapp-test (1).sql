...
ALTER TABLE `farmers_categories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `delete_farmer_category_when_delete_category_id` (`category_id`),
  ADD KEY `delete_farmer_category_when_delete_user_id` (`user_id`);
...
ALTER TABLE `states`
  ADD PRIMARY KEY (`id`),
  ADD KEY `delete_state_when_delete_country` (`country_id`);
...
ALTER TABLE `verify_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `delete_verify_user_when_delete_user_id` (`user_id`);
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `delete_customer_when_delete_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `farmers_categories`
--
ALTER TABLE `farmers_categories`
  ADD CONSTRAINT `delete_farmer_category_when_delete_category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `delete_farmer_category_when_delete_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `states`
  ADD CONSTRAINT `delete_state_when_delete_country` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `verify_users`
  ADD CONSTRAINT `delete_verify_user_when_delete_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
