...
class UpdateVehicleRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
                    ...
                    'driver_id' => 'required',
                    'truck_registration_doc' => 'mimes:jpeg,jpg,png,pdf,odt,doc',
                    'truck_us_dot_doc' => 'mimes:jpeg,jpg,png,pdf,odt,doc',
                    'truck_mc_number_doc' => 'mimes:jpeg,jpg,png,pdf,odt,doc',
                    'truck_insurance_doc' => 'mimes:jpeg,jpg,png,pdf,odt,doc',                     
                ];      
        return $rules;
    }
}
