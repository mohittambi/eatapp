                    ...
                    {{ csrf_field() }}
                     @include('message')
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="full-name">Business Name<span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {!! Form::text('business_name', null, ['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Business Name','required'=>true]) !!}                      
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="full-name">Business Address<span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {!! Form::text('business_address', null, ['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Business Address','required'=>true]) !!}                      
                        </div>
                      </div>
