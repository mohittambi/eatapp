                    ...
                    {{ csrf_field() }}
                     @include('message')
                      ...
                      <div class="form-group row">
                        <?php echo \App\Lib\LanguageConvertor\Translator::languageFields("name","",["table"=>"banners","pk"=>$row->id]); ?>
                      </div>
                      ...
                      <div class="form-group row">
                        <?php echo \App\Lib\LanguageConvertor\Translator::languageFields("description","",["table"=>"banners","pk"=>$row->id]); ?>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="banner_img">Banner Image
                         ...
                         <div class="col-md-4 col-sm-4 col-xs-12">
                          {!! Form::file('banner_img', null, ['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Banner Image','required'=>true, 'id'=>'banner_img']) !!}                      
                        </div>
