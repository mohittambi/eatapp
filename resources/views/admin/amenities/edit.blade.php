              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    {!! Form::model($row, ['method' => 'post','route' => ['admin.'.$model.'.update', $row->id],'class'=>'form-horizontal validate','enctype'=>'multipart/form-data','id'=>'category-add']) !!}
                    {{ csrf_field() }}
                     @include('message')
                      ...
                      <div class="form-group row">
                        <?php echo \App\Lib\LanguageConvertor\Translator::languageFields("name","",["table"=>"amenities","pk"=>$row->id]); ?>
                      </div>
                      ...
                      <div class="form-group row">
                        <?php echo \App\Lib\LanguageConvertor\Translator::languageFields("description","",["table"=>"amenities","pk"=>$row->id]); ?>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cat_img">Category Image
                        </label>
                         <div class="col-md-4 col-sm-4 col-xs-12">
                          {!! Form::file('cat_img', null, ['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Category Image','required'=>true, 'id'=>'cat_img']) !!}                      
                        </div>
