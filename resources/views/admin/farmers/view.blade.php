              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <table class="table table-hover table-striped">
                  <tbody>
                    ...
                    <tr>
                      <td>Categories:</td>
                      <td>{!! $row->farmerDetails->categories !!}</td>
                    </tr>
                    <tr>
                      <td>Banner Image:</td>
                      <td>
                        <img class="img-responsive avatar-view" src="{{ $row->farmerDetails->banner_image?asset('public/uploads/farmers/thumb/'.$row->farmerDetails->banner_image.''):'' }}" alt="Banner Image" title="Change the avatar">
                      </td>
                    </tr>
                    <tr>
                      <td>Created At:</td>
