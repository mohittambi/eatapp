                    ...
                    {{ csrf_field() }}
                     @include('message')
                      ...
                      <div class="form-group row">
                        <?php echo \App\Lib\LanguageConvertor\Translator::languageFields("title","",["table"=>"front_pages","pk"=>0]); ?>
                      </div>

                      <div class="form-group">
                        <label class="control-label" for="content">Content</label>
                        <div class="">
                          {!! Form::textarea('content', null, ['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Content','id'=>'editor']) !!}                      
                        </div>
                      </div>
                      
                      <div class="form-group row">
                        <?php echo \App\Lib\LanguageConvertor\Translator::languageFields("content", "", ["table"=>"front_pages", "pk"=>0, "tag"=>'textarea', "class"=>'front-content', "id"=>'editor-it']); ?>
                      </div>
