                  ...
                  <div class="x_content">
                    ...
                    {{ csrf_field() }}
                     @include('message')
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cat_img">Amenity Image
                        </label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
                          {!! Form::file('cat_img', null, ['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Amenity Image','required'=>true, 'id'=>'cat_img']) !!}                      
                        </div>
